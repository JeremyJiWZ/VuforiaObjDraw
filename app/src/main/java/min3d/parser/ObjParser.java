...
public class ObjParser extends AParser implements IParser {
	 ...
	 * @param resourceID
	 */
	public ObjParser(Resources resources, String resourceID, boolean generateMipMap,AssetManager assetManager1,String fileName) {
		super(resources, resourceID, generateMipMap,assetManager1,fileName);
	}
	...
	public void parse() {
		...
		try {
			fileIn = assetManager.open(fileName);
