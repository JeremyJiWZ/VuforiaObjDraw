...
public class Max3DSParser extends AParser implements IParser {
	...
	public Max3DSParser(Resources resources, String resourceID, boolean generateMipMap,AssetManager assetManager,String fileName) {
		super(resources, resourceID, generateMipMap,assetManager,fileName);
	}
